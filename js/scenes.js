...
*
* Производит инициализацию клавиш для 
* управления игрой.
*  
...
/**
* Инициализация сцены конца игры
*
* Производит инициализацию сцены
* при проигрыше.
*  
* @return void Ничего не возвращает
*/
...
* Загрузка сцены
*
* Производит загрузку текущей сцены.
*  
* @return void Ничего не возвращает
*/
    //Loading Scene
    Crafty.scene('Loading', function() {
        ...
        Crafty.e('2D, Canvas, Text')
            .attr({
                x: Map.grid.tile.width + Map.grid.tile.width /
                    2,
                y: Map.height() / 2
            })
...
*
* Производит загрузку изображений для обьектов.
*  
* @return void Ничего не возвращает
*/
		function() {
...
*
* Производит инициализацию игровой сцены,
* загружает танк игрока.
*  
* @return Crafty Обьект сцены
*/
